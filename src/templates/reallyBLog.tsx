...
// const BlogPostTemplateBackup = (props: any) => {
...
// 					</PostShare>
// 				</BlogPostFooter>
// 				<BlogPostComment className={post.frontmatter.cover == null ? 'center' : ''}>
...
// 									image={
// 										node.frontmatter.cover == null ? null : (
...
// export default BlogPostTemplateBackup;
