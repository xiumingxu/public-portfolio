...
export const NavbarWrapper = styled.div`
	...
	padding: 30px 75px;
	//TODO: add sticky and trasparent header
...
export const MenuItem = styled.li`
	...
	a {
		...
		&.active-link {
			span:after {
				// background: ${themeGet('colors.primary', '#292929')};
				transform: scaleX(1);
			}
		}
...
export const MobileMenuWrapper = styled.div`@media (min-width: 991px) {display: none;}`;
			...
			a {
				...
				p: {
					...
					&:after {
						...
						left: 2px;
						max-width: 30%;
						transition-origin: left center 0;
					}
				}
